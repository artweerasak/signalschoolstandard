  ...
  return (
    <div className="min-h-screen bg-[#f7f5fa] py-10 px-4">
      <div className="max-w-3xl mx-auto bg-white rounded-2xl shadow p-8 space-y-6">
        ...
        <Card>
          <h2 className="font-semibold text-[#2D0F42]">1. การยอมรับข้อกำหนด</h2>
          <p className="text-sm text-[#6b6478] leading-relaxed">
        ...
        <Card>
          <h2 className="font-semibold text-[#2D0F42]">2. คุณสมบัติและสิทธิการเข้าใช้งาน</h2>
        ...
        <Card>
          <h2 className="font-semibold text-[#2D0F42]">3. บัญชีผู้ใช้และการรักษาความปลอดภัย</h2>
          <ul className="text-sm text-[#6b6478] space-y-1 list-disc list-inside">
        ...
        <Card>
          <h2 className="font-semibold text-[#2D0F42]">4. ข้อปฏิบัติและข้อห้ามในการใช้งาน</h2>
          <ul className="text-sm text-[#6b6478] space-y-1 list-disc list-inside">
        ...
        <Card>
          <h2 className="font-semibold text-[#2D0F42]">5. ทรัพย์สินทางปัญญาและชั้นความลับ</h2>
          <p className="text-sm text-[#6b6478] leading-relaxed">
        ...
        <Card>
          <h2 className="font-semibold text-[#2D0F42]">6. ความถูกต้องของผลการสอบและใบประกาศนียบัตร</h2>
          <p className="text-sm text-[#6b6478] leading-relaxed">
        ...
        <Card>
          <h2 className="font-semibold text-[#2D0F42]">7. การระงับและยกเลิกสิทธิการใช้งาน</h2>
          <p className="text-sm text-[#6b6478] leading-relaxed">
        ...
        <Card>
          <h2 className="font-semibold text-[#2D0F42]">8. ข้อจำกัดความรับผิด</h2>
          <p className="text-sm text-[#6b6478] leading-relaxed">
        ...
        <Card>
          <h2 className="font-semibold text-[#2D0F42]">9. กฎหมายที่ใช้บังคับ</h2>
          <p className="text-sm text-[#6b6478] leading-relaxed">
        ...
        <Card>
          <h2 className="font-semibold text-[#2D0F42]">10. การเปลี่ยนแปลงข้อกำหนด</h2>
          <p className="text-sm text-[#6b6478] leading-relaxed">
