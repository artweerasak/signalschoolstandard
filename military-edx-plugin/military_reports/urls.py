...
# PDX export (ส่งออกฟอร์มนำเข้าระบบ PDX ของ ทบ.)
from .pdx_views import api_export_pdx, api_export_count, api_units_list
...
urlpatterns = [
    ...
    path("api/v1/reports/export/count/", api_export_count, name="api_export_count"),
